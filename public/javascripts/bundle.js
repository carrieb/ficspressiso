...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ReactDOM = __webpack_require__(167),
	    App = React.createFactory(__webpack_require__(158));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Browse = __webpack_require__(168);
	...
	var App = React.createClass({displayName: "App",
	  ...
	  render:function() {
	    ...
	    sectionContent = '';
	    sectionEls = sections.map(function(section)  {
	      selected = (section === this.state.section ? " active" : "");
	      return (React.createElement("a", {className:  "ui item" + selected, onClick:  this.setActive, key:  section },  section ));
	    }.bind(this));
	    if (this.state.section === "Library") {
	      sectionContent = (React.createElement(Library, null));
	    } else if (this.state.section === "Browse") {
	      sectionContent = (React.createElement(Browse, null));
	    }
	    console.log(this.state.section, sectionContent);
	    return (React.createElement("div", null, 
	      React.createElement("div", {className: "ui teal large secondary pointing menu", style: { marginBottom: '20px'}}, 
	         sectionEls, 
	        React.createElement("div", {className: "right menu"}, 
	          React.createElement("a", {className:  "ui item" + (this.state.section === "Settings" ? " active": ""), onClick:  this.setActive, key: "Settings"}, "Settings")
	        )
	      ), 
	       sectionContent 
	    ));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	  FFList = __webpack_require__(160),
	  FFReader = __webpack_require__(163),
	  FFFilter = __webpack_require__(162);
	...
	var Library = React.createClass({displayName: "Library",
	  ...
	  onRetrievedFicContent:function(data, title, chp) {
	    console.log("Retrieved content for " + title + ": " + chp, data);
	    var meta = this.getMetaForFic(title);
	    var split = data.split(/\r\n|\r|\n/);
	    var result = split.map(function(item, index)  {
	      if (item.length > 0) {
	        return (
	  ...
	  requestFFContent:function(callback, title, chp) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    FFItem = React.createFactory(__webpack_require__(161)),
	    FFFilter = __webpack_require__(162);

	var FFList = React.createClass({displayName: "FFList",
	  render:function() {
	    var rows = []
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FFItem = React.createClass({displayName: "FFItem",
	  render:function() {
	    return (
	      React.createElement("div", {className: "ffitem" + ( this.props.selected ? " selected" : "")}, 
	        React.createElement("div", {className: "ui" + (this.props.selected ? " selected" : "") + " raised card"}, 
	          React.createElement("div", {className: "content"}, 
	            React.createElement("div", {className: "header"}, 
	              React.createElement("b", {className: "title"},  this.props.data.title), React.createElement("br", null), React.createElement("span", {className: "author"}, "by ",  this.props.data.author)
	            )
	          ), 
	          ...
	          React.createElement("div", {className: "content"}, 
	            ...
	            React.createElement("div", {className: "details"}, 
	              React.createElement("b", null,  this.props.data.fandoms.join(", ") ), " » ",  this.props.data.chars.join(", ") 
	            )
	          ), 

	          React.createElement("div", {className: "ui bottom "+ (this.props.selected ? " green" : " blue") + " button", onClick:  this.read}, 
	              React.createElement("i", {className: "book icon"}), 
	              "Read"
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FFFilter = React.createClass({displayName: "FFFilter",
	  render:function() {
	    ...
	    var filterDropdown = (
	      React.createElement("div", {id: "fic_filter", className: "ui labeled icon top center pointing dropdown button"}, 
	        React.createElement("i", {className: "filter icon"}), 
	        React.createElement("span", {className: "text", id: "selected_filter"}, "Filter Stories"), 
	  ...
	  handleChange:function(value, text, choice) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    FFReaderNav = __webpack_require__(164),
	    FFJumpModal = __webpack_require__(166);

	var FFReader = React.createClass({displayName: "FFReader",
	  render:function() {
	    var jumpCssClass = "jump";
	    var ficLabel = (
	      React.createElement("div", {className: "ui large teal bottom right attached label"}, 
	        this.props.ficTitle, 
	        React.createElement("div", {className: "detail"}, this.props.currentChp + 1, "/", this.props.lastChp + 1)
	      )
	    );
	    var content = (
	      React.createElement("div", {className: "fic_content ui very padded text segment"}, 
	        React.createElement("div", {style: { textAlign: "center"}}, 
	          React.createElement("h2", null,  this.props.chpTitle)
	        ), 
	         this.props.content
	      )
	    );
	    ...
	    if (this.props.content.length > 0) {
	      side_options = (
	        React.createElement(FFReaderNav, {jumpToChapter:  this.props.loadFicContent, 
	                     currentChapter:  this.props.currentChp, 
	                     lastChapter:  this.props.lastChp, 
	                     jumpCssClass:  jumpCssClass })
	      );
	      jump_modal = (
	        React.createElement(FFJumpModal, {jumpToChapter:  this.props.loadFicContent, 
	                     chapterOptions:  this.props.chapters, 
	                     cssClass:  jumpCssClass })
	      );
	    }
	    return (
	      React.createElement("div", {className: "fic_reader"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FFReaderNav = React.createClass({displayName: "FFReaderNav",
	  ...
	  render:function() {
	    var prev = (React.createElement(Button, {key: "prev", icon: "arrow left", callback:  this.prev}));
	    var jump = (React.createElement(Button, {key: "jump", icon: "share square", callback:  this.showJumpModal}));
	    var next = (React.createElement(Button, {key: "next", icon: "arrow right", callback:  this.next}));
	    var last = (React.createElement(Button, {key: "last", icon: "fast forward", callback:  this.last}));
	    var options = []
	    ...
	    return (
	      React.createElement("div", {className: "side_options ui vertical icon buttons"}, 
	         options 
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = React.createClass({displayName: "Button",
	  render:function() {
	    return (
	      React.createElement("button", {className: "ui button", onClick:  this.props.callback, key:  this.props.key}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FFJumpModal = React.createClass({displayName: "FFJumpModal",
	  doJump:function() {
	  ...
	  render:function() {
	    ...
	    for (var i = 0; i < this.props.chapterOptions.length; i++) {
	      ...
	      chapterOptions.push(
	        React.createElement("option", {value:  i, key:  i },  chapter['title'] )
	      );
	    }
	    return (
	      React.createElement("div", {className:  "ui modal " + this.props.cssClass}, 
	        React.createElement("div", {className: "header"}, "Jump to Chapter"), 
	        React.createElement("div", {className: "content"}, 
	          React.createElement("div", {className: "ui form"}, 
	            React.createElement("div", {className: "field"}, 
	              React.createElement("label", null, "Chapter"), 
	              React.createElement("select", {id: "chapter_select", className: "ui search dropdown"}, 
	                React.createElement("option", {value: ""}, "Select Chapter"), 
	                 chapterOptions 
	              )
	            )
	          )
	        ...
	        React.createElement("div", {className: "actions"}, 
	          ...
	          React.createElement("div", {className: "ui positive right labeled icon button"}, 
	            React.createElement("i", {className: "share square icon"}), 
	            "Jump"
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Browse = React.createClass({displayName: "Browse",
	  getInitialState:function() {
	    return {
	      'content' : 'Loading...'
	    }
	  ...
	  render:function() {
	    return (React.createElement("div", {className: "browse_content"}, 
	      React.createElement("div", {className: "ui relaxed items", dangerouslySetInnerHTML: this.createMarkup()})
	    ));
	  },
